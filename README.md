...
[![R-CMD-check](https://github.com/ready4-dev/costly/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ready4-dev/costly/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->

Tools for undertaking unit costing in conjunction with
...
devtools::install_github("ready4-dev/costly")
