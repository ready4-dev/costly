...
y <- ready4class::ready4class_constructor() %>%
  dplyr::bind_rows(ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE,
                   ...
                   ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE,
                                                                ...
                                                                parent_class_chr = "Ready4Module",
                                                                inc_clss_ls = list("CostlySeed","CostlySource","CostlyStandards") %>% list()),
                   ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE,
                                                                name_stub_chr = "Countries",
                                                                slots_ls = list("CostlySeed_r4",
                                                                                "CostlyStandards_r4",
                                                                                "fuzzy_logic_1L_chr") %>% list(),
                                                                pt_ls = list("CostlySeed",
                                                                             "CostlyStandards",
                                                                             "character") %>% list(),
                                                                vals_ls = list(list(CostlySeed_r4 = "add_source_label(CostlySeed(),\"Country\")",
                                                                                    CostlyStandards_r4 = "CostlyStandards(Ready4useDyad_r4 = add_country_standards(),
                                                                                                                         include_chr = c(\"Country\", \"Official\",\"Common\",\"A3\",\"A2\"),
                                                                                                                         label_1L_chr = \"Country\")",#"make_country_standards()",
                   ...
                   ready4class::make_pt_ready4class_constructor(make_s3_lgl = FALSE,
                                                                ...
                                                                slots_ls = list("CostlySeed_r4",
                                                                                "CostlyStandards_r4") %>% list(),
                                                                pt_ls = list("CostlySeed",
                                                                             "CostlyStandards") %>% list(),
                                                                vals_ls = list(list(CostlySeed_r4 = "add_source_label(CostlySeed(),\"Currency\")",
                                                                                    CostlyStandards_r4 = "CostlyStandards(Ready4useDyad_r4 = add_currency_standards(),
                                                                                                                         include_chr = c(\"Currency\", \"Letter\"),
                                                                                                                         label_1L_chr = \"Currency\")"#"make_currency_standards()"
                                                                                    )),
