...
#' @name renew-CostlyCorrespondences
#' @description renew method applied to CostlyCorrespondences
...
#' @param type_1L_chr Type (a character vector of length one), Default: 'slot'
#' @param what_1L_chr What (a character vector of length one), Default: 'correspondences'
#' @param ... Additional arguments
#' @return x (An object of class CostlyCorrespondences)
#' @rdname renew-methods
#' @aliases renew,CostlyCorrespondences-method
#' @export 
#' @importFrom ready4 renew
methods::setMethod("renew", "CostlyCorrespondences", function (x, new_val_xx = NULL, type_1L_chr = "slot", what_1L_chr = "correspondences", 
    ...) 
{
    ...
    if (type_1L_chr %in% c("exploratory", "final", "slot")) {
        ...
        if (what_1L_chr == "correspondences") {
            ...
            if (is.null(new_val_xx) | !identical(new_val_xx, 
                ...
                x@correspondences_r3 <- update_correspondences(correspondences_x_r3 = x@correspondences_r3, 
                  standards_df = x@CostlyStandards_r4@Ready4useDyad_r4@ds_tb %>% 
                    as.data.frame(), standards_var_nms_chr = procure(x@CostlyStandards_r4, 
                    matches_chr = x@CostlyStandards_r4@include_chr, 
                    what_1L_chr = "names"), seed_df = x@CostlySeed_r4@Ready4useDyad_r4@ds_tb %>% 
                    as.data.frame(), reference_var_nm_1L_chr = procure(x@CostlySeed_r4, 
                    matches_chr = x@CostlySeed_r4@label_1L_chr, 
                    what_1L_chr = "names"), force_standard_1L_lgl = x@force_standard_1L_lgl, 
            ...
            if (type_1L_chr == "slot") {
                x <- update_module_slot(x, y_r3 = y, what_1L_chr = what_1L_chr, 
