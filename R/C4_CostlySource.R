...
slots = c(Ready4useDyad_r4 = "Ready4useDyad",include_chr = "character",label_1L_chr = "character",match_1L_chr = "character",dissemination_1L_chr = "character"),
prototype =  list(Ready4useDyad_r4 = ready4use::Ready4useDyad(),include_chr = NA_character_,label_1L_chr = "Standardised",match_1L_chr = "A3"))
